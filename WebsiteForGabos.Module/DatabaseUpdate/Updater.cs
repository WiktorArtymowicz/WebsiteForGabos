...
using WebsiteForGabos.Module.BusinessObjects.Planning;
using WebsiteForGabos.Module.BusinessObjects.Marketing;



namespace WebsiteForGabos.Module.DatabaseUpdate {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if (ObjectSpace.CanInstantiate(typeof(ProjectTask)))
            {
                ...
                if (task == null)
                {
                    ...
                    task.ProjectTaskStatus = ProjectTaskStatus.InProgress;
