...
using WebsiteForGabos.Blazor.Server.Services;

namespace WebsiteForGabos.Blazor.Server {
    public partial class WebsiteForGabosBlazorApplication : BlazorApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static WebsiteForGabosBlazorApplication() {
            DevExpress.Persistent.Base.PasswordCryptographer.EnableRfc2898 = true;
            DevExpress.Persistent.Base.PasswordCryptographer.SupportLegacySha512 = false;
            DevExpress.ExpressApp.BaseObjectSpace.ThrowExceptionForNotRegisteredEntityType = true;
        }
        #endregion
        public WebsiteForGabosBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void WebsiteForGabosBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
